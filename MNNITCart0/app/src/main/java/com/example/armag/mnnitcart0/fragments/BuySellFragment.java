 ...
 * {@link BuySellFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BuySellFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BuySellFragment extends Fragment implements View.OnClickListener {

    public static final String TAG = "BuySellFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.sellButton).setOnClickListener(this);
        return view;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sellButton:
                mListener.willBuySell(false);
                break;
        }
    }

    public interface OnFragmentInteractionListener {
        void willBuySell(boolean willBuy);
    }
}
